...
var SOCIAL_LINKS = [
    {
        name: "CV",
        link: "https://drive.google.com/file/d/1FZPK-P-In7p8f2Tt0zxIEGTW3QQFESQE/view"
    },
    {
        name: "GitHub",
        link: "https://github.com/RAS-95",
...
function generatePaperTable(idName, PAPER) {
    ...
    if (tableContainer && (PAPER === null || PAPER === void 0 ? void 0 : PAPER.length) > 0) {
        PAPER.forEach(function (paper) {
            ...
            if ((_g = paper === null || paper === void 0 ? void 0 : paper.place) === null || _g === void 0 ? void 0 : _g.nb) {
                var nbElement = document.createElement('span');
